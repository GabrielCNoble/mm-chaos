...
struct ChaosCodeDef gChaosCodeDefs[] = {
    ...
    /* [CHAOS_CODE_LOW_GRAVITY]             = */ CHAOS_CODE_DEF(10, 18, true,  0.1f),
    /* [CHAOS_CODE_CHANGE_HEALTH]           = */ CHAOS_CODE_DEF(1,  10, false, 0.1f),
    /* [CHAOS_CODE_CHANGE_RUPEE]            = */ CHAOS_CODE_DEF(0,  0,  true,  0.1f),
    /* [CHAOS_CODE_ACTOR_CHASE]             = */ CHAOS_CODE_DEF(6,  15, false, 0.04f),
    /* [CHAOS_CODE_YEET]                    = */ CHAOS_CODE_DEF(8,  17, true,  0.05f),
    /* [CHAOS_CODE_POKE]                    = */ CHAOS_CODE_DEF(0,  0,  false, 0.05f),
    ...
    /* [CHAOS_CODE_TIMER_UP]                = */ CHAOS_CODE_DEF(10, 20, false, 0.007f),
    /* [CHAOS_CODE_SHOCK]                   = */ CHAOS_CODE_DEF(0,  0,  false, 0.05f),
    /* [CHAOS_CODE_EARTHQUAKE]              = */ CHAOS_CODE_DEF(0,  0,  true,  0.1f),
    ...
    /* [CHAOS_CODE_CHANGE_MAGIC]            = */ CHAOS_CODE_DEF(1,  10, true,  0.1f),
    ...
    /* [CHAOS_CODE_SLOW_DOWN]               = */ CHAOS_CODE_DEF(10, 20, false, 0.012f),
...
u8 Chaos_RandomCode(void)
{
    ...
    s32 search_index = CHAOS_CODE_LAST >> 1;
...
{
    Chaos_DropCodeAtIndex(gChaosContext.active_code_indices[code]);
}
