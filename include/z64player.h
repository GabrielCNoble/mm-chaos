...
#define PRESERVE_ROT_FOCUS_X (1 << 0)
#define PRESERVE_ROT_FOCUS_Y (1 << 1)
#define PRESERVE_ROT_FOCUS_Z (1 << 2)
#define PRESERVE_ROT_HEAD_X (1 << 3)
#define PRESERVE_ROT_HEAD_Y (1 << 4)
#define PRESERVE_ROT_HEAD_Z (1 << 5)
#define PRESERVE_ROT_UPPER_X (1 << 6)
#define PRESERVE_ROT_UPPER_Y (1 << 7)
#define PRESERVE_ROT_UPPER_Z (1 << 8)
...
typedef struct Player {
    ...
    /* 0xAA4 */ s8 idleType;
    /* 0xAA5 */ u8 unk_AA5; // first person mode
